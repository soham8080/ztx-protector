...
rarities = ['⚪️ Common', '🟣 Rare', '🟡 Legendary', '🟢  Medium', '💮 Special edition', '🔮 Limited Edition']
spawn_weights = [10, 6, 3, 5, 1, 1]  # Adjusted spawn weights based on rarity
...
async def guess(update: Update, context: CallbackContext) -> None:
    ...
    if sorted(name_parts) == sorted(guess.split()) or any(part == guess for part in name_parts):
        ...
        await update.message.reply_text("You received 60 coins for correctly guessing the character! ✨️")
